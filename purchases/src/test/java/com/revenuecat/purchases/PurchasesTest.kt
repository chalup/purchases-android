...
class PurchasesTest {
    ...
    fun canMakePurchaseUpgradeOfAPackage() {
        ...
        every {
            ...
            lambda<(BillingResult, PurchaseDetails?) -> Unit>().captured.invoke(
                BillingResult(),
                oldPurchase
            )
        }
    ...
    fun `Send error if cannot find the old purchase associated when upgrading a SKU`() {
        ...
        every {
            ...
            lambda<(BillingResult, PurchaseDetails?) -> Unit>().captured.invoke(BillingResult(), null)
        }
    ...
    fun `Send error if cannot find the old purchase associated when upgrading a SKU due to a billingclient error`() {
        ...
        every {
            ...
            lambda<(BillingResult, PurchaseDetails?) -> Unit>().captured.invoke(stubBillingResult, null)
        }
